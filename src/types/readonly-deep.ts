...
export type ReadonlyDeep<T> = T extends BuiltIns
  ...
  : T extends new (...arguments_: any[]) => unknown
    ...
    : T extends (...arguments_: any[]) => unknown
      ? EmptyObject extends ReadonlyObjectDeep<T>
        ? T
...
type ReadonlyMapDeep<KeyType, ValueType> =
  EmptyObject & Readonly<ReadonlyMap<ReadonlyDeep<KeyType>, ReadonlyDeep<ValueType>>>;

type ReadonlySetDeep<ItemType> =
  EmptyObject & Readonly<ReadonlySet<ReadonlyDeep<ItemType>>>;
